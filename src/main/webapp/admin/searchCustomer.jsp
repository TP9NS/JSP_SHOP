...
<%
 ...
 int currentPage = (request.getParameter("page") != null) ? Integer.parseInt(request.getParameter("page")) : 1;
    ...
    // 쿼리에서 ?에 값을 바인딩할 PreparedStatement 생성
    String countQuery = "SELECT COUNT(*) AS total FROM customer WHERE customer_id LIKE ? OR name LIKE ?";
                ...
                <%
                    try {
                        ...
                        PreparedStatement stmt = con.prepareStatement(
                        		"SELECT * FROM customer WHERE customer_id = ? OR name = ? LIMIT ?, ?");
