...
<%
    ...
    try {
        ...
        // SQL 쿼리 작성
        String sql = "INSERT INTO product (product_name, manufacturer, price, product_image1, product_image2, product_image3, product_image4, product_description, category) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        if (rowsInserted > 0) {
            ...
            if (generatedKeys.next()) {
                int productId = generatedKeys.getInt(1); // 생성된 상품의 ID 가져오기
                // size 테이블에 상품과 사이즈 정보 저장
