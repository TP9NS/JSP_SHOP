  ...
  <div class="navbar navbar-dark bg-dark shadow-sm">
    ...
    <% } else { %>
        ...
        <% if (permission != null && permission.equals("1")) { %>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/admin/productRegister.jsp">상품등록하기</a>
            </li>
            <li class="nav-item">
...
<main class="container">
   <div class="product-form">
        <h2>상품 수정</h2>
        <form action="editProduct_process.jsp?productId=<%=productid %>" method="post">
            <label for="productName">상품명:</label>
            <input type="text" id="productName" name="productName" value="<%= productName %>" required>

            <label for="manufacturer">제작사:</label>
            <input type="text" id="manufacturer" name="manufacturer" value="<%= productManufacturer %>" required>
            ...
            <input type="text" id="productImage1" name="productImage1" value="<%= productImage1 %>" required>

            <label for="productImage2">상품사진2:</label>
            <input type="text" id="productImage2" name="productImage2" value="<%= productImage2 %>" required>

            <label for="productImage3">상품사진3:</label>
            <input type="text" id="productImage3" name="productImage3" value="<%= productImage3 %>" required>

            <label for="productImage4">상품사진4:</label>
            <input type="text" id="productImage4" name="productImage4" value="<%= productImage4 %>" required>
