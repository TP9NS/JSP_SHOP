...
<%
    ...
    ResultSet countRs = countStmt.executeQuery("SELECT COUNT(*) AS total FROM product WHERE category ='신발' ");
    countRs.next();
...
<main>
    ...
    // permission이 1일 때 상품 구매하기 버튼을 숨김
                ...
                <% 
                    try {
                        ...
                        // 상품 목록 가져오기
                        PreparedStatement stmt = con.prepareStatement("SELECT * FROM product WHERE category ='신발' LIMIT ?, ?");
                        stmt.setInt(1, start);
    ...
    <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <% if (!hideBuyButton) { %>
                <a href="/SHOP/user/product.jsp?id=<%= productId %>" class="btn btn-primary">상품수정</a>
            <% } else { %>
