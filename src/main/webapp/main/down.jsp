...
<%
    ...
    ResultSet countRs = countStmt.executeQuery("SELECT COUNT(*) AS total FROM product WHERE category ='하의' ");
    countRs.next();
    ...
    // permission이 1일 때 상품 구매하기 버튼을 숨김
                ...
                <% 
                    try {
                        ...
                        // 상품 목록 가져오기
                        PreparedStatement stmt = con.prepareStatement("SELECT * FROM product WHERE category ='하의' LIMIT ?, ?");
                        stmt.setInt(1, start);
